import{A as e}from"./UIcon.5d1cd9b8.js";import{g as n}from"./skills.c80b28e1.js";import{C as t}from"./types.1ebf2f37.js";const s=[{slug:"full-stack-rentino",company:"Rentino",description:`<h2>Full-Stack Developer – Peer-to-Peer Rental Marketplace</h2>
...
</ul>`,contract:t.FullTime,type:"Software Development",location:"Remote",period:{from:new Date(2024,7,1),to:new Date(2025,8,1)},skills:n("react","ts","react-query","JS","django","python","docker","git","sentry","datadog"),name:"Software Developer",color:"red",links:[],logo:e.Empty,shortDescription:"Delivered full-stack features with React/TypeScript and Django REST for a B2B SaaS platform, improving UI performance and production observability."},{slug:"mla-assistant",company:"Legislative Assembly of Alberta",description:"<h2>MLA Assistant – Government Administration Support</h2><p>    As an <strong>MLA Assistant</strong>, I provided administrative and logistical support to a Member of the Legislative Assembly (MLA),     ensuring smooth operations, effective communication, and efficient handling of governmental responsibilities.</p><h3>Key Responsibilities</h3><ul>    <li><strong>Administrative Support:</strong> Managed schedules, correspondence, and documentation for the MLA.</li>    <li><strong>Public Relations:</strong> Assisted in handling constituent inquiries, complaints, and service requests.</li>    <li><strong>Legislative Research:</strong> Conducted research on policies, bills, and government initiatives.</li>    <li><strong>Community Engagement:</strong> Coordinated meetings, events, and public outreach programs.</li>    <li><strong>Government Liaison:</strong> Communicated with various government departments and officials.</li></ul><h3>Impact</h3><ul>    <li><strong>Streamlined administrative processes</strong> to improve office efficiency.</li>    <li><strong>Enhanced constituent services</strong> by promptly addressing community concerns.</li>    <li><strong>Strengthened public engagement</strong> by organizing community meetings and events.</li>    <li><strong>Supported policy initiatives</strong> through research and documentation.</li></ul>",contract:t.FullTime,type:"MLA Assistance",location:"Camrose, AB, Canada",period:{from:new Date(2024,9,1),to:new Date(2025,9,1)},skills:n(),name:"MLA Assistant",color:"blue",links:[],logo:e.LogoLAO,shortDescription:"Assisting Camrose MLA with scheduling meetings and communication with public."},{slug:"software-freelance-junior",company:"UpWork",description:`<h2>Junior Freelancer – Web Development</h2>
...
</ul>`,contract:t.Freelance,type:"Software Development",location:"Remote",period:{from:new Date(2021,0,1),to:new Date(2023,10,1)},skills:n("JS","git"),name:"Junior Freelancer",color:"green",links:[],logo:e.Unknown,shortDescription:"Delivered responsive website builds and performance optimisations for 10+ clients on UpWork, achieving 90% first/second-revision approval rate."}],a="Experience";export{s as i,a as t};
